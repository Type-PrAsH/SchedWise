        ...
        return (
          <div className="max-w-md mx-auto flex flex-col justify-center h-full space-y-10">
            ...
            <div className="space-y-4">
              ...
              className="w-full py-4 bg-white text-black font-black rounded-2xl flex items-center justify-center gap-3 hover:bg-gray-100 transition-colors">
              ...
              <button disabled className="w-full py-4 bg-primary text-black font-black rounded-2xl shadow-lg shadow-primary/20 hover:brightness-110">Sign In (coming soon)</button>
            </div>
